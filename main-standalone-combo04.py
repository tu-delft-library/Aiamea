...
class App(tk.Tk):
    ...
    def build_ui(self):
        ...
        # =========================================================
        # ONE LARGE SCROLLABLE AREA FOR THE ENTIRE APPLICATION
        # =========================================================
        ...
        def resize_inner_frame(event):
            ...
            try:
                about_label.configure(
                    wraplength=max(300, event.width - 30)
                )
            except NameError:
                pass
        ...
        def on_mousewheel(event):
            # Keep one visible scrollbar for the whole application.
            # The Log Text widget can still scroll independently with
            # the mouse wheel when the pointer is over it.
            if event.widget == self.txt:
                if event.delta:
                    self.txt.yview_scroll(

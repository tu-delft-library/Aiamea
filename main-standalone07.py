...
class App(tk.Tk):
    ...
    def build_ui(self):
        ...
        ttk.Label(opts, text="Prompt Mode").grid(row=4, column=0, sticky='w')
        ...
        self.prompt_entry.grid(row=3, column=0, sticky='ew', padx=(0, 8))
        ...
        self.prompt_btn.grid(row=3, column=1)
